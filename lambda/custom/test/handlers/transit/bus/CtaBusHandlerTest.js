...
describe('CtaBusHandler Tests', function() {
    ...
    beforeEach(function() {
        process.env.CTABUS_API_KEY = CTA_BUS_API_KEY;
        ...
        .query({key: CTA_BUS_API_KEY, rt: '20', stpid: '4727', format: 'json'})
        .reply(200, getPred20Response);

         // Mock CTA API call
         nock('http://ctabustracker.com')
         .get('/bustime/api/v2/getpredictions')
         .query({key: CTA_BUS_API_KEY, rt: '20', stpid: '386', format: 'json'})
         .reply(200, getPred20Response);

        // Mock CTA API call
        nock('http://ctabustracker.com')
        .get('/bustime/api/v2/getpredictions')
        .query({key: CTA_BUS_API_KEY, rt: '49', stpid: '8245', format: 'json'})
        .reply(200, getPred49Response);
        
        // Mock getpatterns
        nock('http://ctabustracker.com')
            .get('/bustime/api/v2/getpatterns')
            .query({key: CTA_BUS_API_KEY, rt: '20', format: 'json'})
            .reply(200, getPatterns20Response);

        // Mock getpatterns
        nock('http://ctabustracker.com')
            .get('/bustime/api/v2/getpatterns')
            .query({key: CTA_BUS_API_KEY, rt: '49', format: 'json'})
